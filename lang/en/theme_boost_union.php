...
$string['sections-boost_union'] = 'boost_union Default Style';
...
$string['navbarlink'] = 'Navbar link color';
$string['navbarlink-hover'] = 'Navbar link hover/selected color';
$string['navbarlink_desc'] = 'Change the color of the navbar links and variables.';
$string['drawerbg'] = 'Drawer background color';
$string['drawerbg_desc'] = 'Change the color of the drawer background.';
$string['courseheaderbg'] = 'Course Header Background Color';
$string['courseheaderbg_desc'] = 'Change the color of the header area background.';
$string['bodybg'] = 'Body background color';
$string['bodybg_desc'] = 'Change the color of the body background.';
$string['navbarsitetitlecolor'] = 'Navbar Site Title Color';
$string['navbarsitetitlecolor_desc'] = 'Chaneg the color of the site title in the top navbar.';
